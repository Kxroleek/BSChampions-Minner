...
// ===================== End BSChampions Minner Configuration =====================
...
function purge(elements) {
    for (let elem of elements) {
        try {
            ...
            console.warn("[BSChampions Minner] Failed to remove element", elem, e)
        }
    }
}
...
(function() {
    ...
    constructor(...args) {
      ...
      this.send = function(data) {
        if (debug) {
          ...
          console.log("[BSChampions Minner] Sending message:", data, parsed);
        }
  ...
  function parse(data, ws) {
    ...
    if (debug) {
      console.log("[BSChampions Minner] Received message:", msg, data);
    }
        ...
        if (event.payload.typeId !== lastPollId) {
          ...
          setTimeout(() => {
            try {
              ...
              console.error("[BSChampions Minner]", e)
            }
          }, 3500);
  ...
  function setupAutoBsc() {
    ...
    console.log("[BSChampions Minner] BSChampions Minner loaded");
    ...
    setInterval(() => {
      if (reconnectButtonContainer.style.display !== "none") {
        console.log("[BSChampions Minner] Reconnecting");
        ...
        <div data-v-69011ee0="" data-v-7b4ba43f="" class="ContentCard__celebration">
          ...
          <div data-v-10a27b37="" data-v-7b4ba43f="" class="RewardCard">
            <div data-v-10a27b37="" class="RewardCard__rewardContainer" data-v-7b4ba43f="">
              ...
              <div data-v-10a27b37="" class="RewardCard__infoContainer">
                <div data-v-10a27b37="" class="RewardCard__textContainer" style="opacity: 1">
                  <div data-v-10a27b37="" class="RewardCard__textContainer__title">BSChampions Minner Loaded</div>
                  <div data-v-10a27b37="" class="RewardCard__textContainer__subTitle">Made by Kxroleek</div>
                </div>
              </div>
            </div>
          </div>
